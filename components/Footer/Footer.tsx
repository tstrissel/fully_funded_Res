      ...
      <div className={styles.container}>
        <div className={styles.inner}>
          ...
          <div className={styles.footerEntries}>
            <Link href="/about" className={styles.footerEntry}>
              ABOUT
            </Link>
            <Link href="/contact" className={styles.footerEntry}>
              CONTACT
            </Link>
            <Link href="/" className={styles.footerEntry}>
              OPEN CALLS
            </Link>
            <Link href="/resources" className={styles.footerEntry}>
              RESOURCES
            </Link>
            <Link href="/interviews" className={styles.footerEntry}>
              INTERVIEWS
            </Link>
          </div>
        </div>
        <div>
          ...
          <div className={styles.support}>
            ...
            <Link href="https://buymeacoffee.com/fullyfundedresi" target="_blank">
              <Image src={buymeacoffee} width={180} height={50} alt="Buy me a coffee" />
            </Link>
