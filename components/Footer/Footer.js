        ...
        return (
            <div className={styles.footer}>
                <div className={styles.logoSocial} >
                    ...
                    <Image className='logo' src= { Logo } alt="FFR" width="100" height="100" /> 
                    <Link href='/'>
            ...
            <Link href='/'>
              <a className='footAbout'>    
                About 
              </a>
            </Link>
            <Link href='/'>
              <a className='footContact'>                
              Contact 
              </a>
            </Link>
            <Link href='/'>
              <a className='footOpenCalls'>
                Open Calls
              </a>
            </Link>
            <Link href='/'>
              <a className='footResources'>
                Resources
              </a>
            </Link>
            <Link href='/'>
              <a className='footInterviews'>
                Interviews
              </a>
            </Link>
            </div>
