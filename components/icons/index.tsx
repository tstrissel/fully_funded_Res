...
function DollarSign() {
  return <Image src={dollarSign} width={34} height={35} alt="Dollar sign" />
}

function LocationPin() {
  return (
    <Image src={locationSign} width={34} height={35} alt="Location pin" />
  )
}
...
function ProfileIndividual() {
  return (
    <Image
      src={profileIndividual}
      width={34}
      height={35}
      alt="Profile individual"
    />
  )
}

function ProfileCollective() {
  return (
    <Image
      src={profileCollective}
      width={34}
      height={35}
      alt="Profile collective"
    />
  )
}

function ArtField(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      width={26}
      height={26}
